            ...
            <div class="wrapper">
                <div class="bg-wrap">
                    ...
                    <div class="cart-box">
                        ...
                        <form id="orderForm" name="orderForm" @submit.prevent="submitForm" :rules="rules" ref="ruleForm">
                            <div class="form-box address-info">
                                <dl class="form-group">
                                    <dt>收货人姓名：</dt>
                                    <dd>
                                        <input name="book_id" id="book_id" type="hidden" value="0">
                                        <input name="accept_name" id="accept_name" type="text" class="input" datatype="s2-20" sucmsg=" " v-model="form.name">
                            ...
                            <div class="buy-foot clearfix">
                                ...
                                <div class="right-box">
                                    <p>
                                        ...
                                        <label id="goodsAmount" class="price">{{price()}}</label> 元&nbsp;&nbsp;&nbsp;&nbsp;
                                    </p>
                                    <p>
                                        运费：￥
                                        <label id="expressFee" class="price">20</label> 元
                                    </p>
                                    <p class="txt-box">
                                        应付总金额：￥
                                        <label id="totalAmount" class="price">{{price() + 20}}</label>
                                    </p>
                                    <p class="btn-box">
  ...
  methods: {
    ...
    price() {
      return this.goodsList.reduce(
        (sum, v) => (sum += v.sell_price * this.$store.state.cart[v.id]),
        0
      );
    },
    /* 提交表单 */
